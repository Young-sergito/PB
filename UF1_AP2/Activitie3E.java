 ...
 * @author YoungSxrgioo
 */
public class Activitie3E {
    private final static int MAX = 50; //declare constant max 
    private final static int MIN = 25; //declare constant min
    private final static String MSG_1 = "insert a number: "; //declare constant message
    private final static String MSG_2 = " the number is into 25 and 50 "; //declare constant message
    private final static String MSG_3 = " the number isnt  into 25 and 50 "; //declare constant message
